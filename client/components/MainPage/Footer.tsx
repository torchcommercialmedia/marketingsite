...
const Footer = () => {
  const navigation = {
    features: [
      ...
      { name: "Inventory Management", href: "#tools" },
      { name: "Dashboard & Reporting", href: "#tools" },
    ],
    uses: [
      { name: "Exotic & Classic Dealers", href: "#uses" },
      { name: "Auto Photography Companies", href: "#uses" },
      { name: "Wrap Shops", href: "#uses" },
      { name: "Mobile Detail Service", href: "#uses" },
      { name: "Wheel Refinishing Shops", href: "#uses" },
      { name: "Mobile Repair Shops", href: "#uses" },
    ],
    company: [
  ...
  return (
    <footer
      id="footer"
      className="mx-auto min-h-screen max-w-7xl relative pb-40"
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-4">
            ...
            <div className="flex space-x-2 items-center">
              <FiPhoneCall />
              <p className="text-sm leading-6 text-gray-600">(214) 450-0811</p>
            </div>
            <div className="flex space-x-2 items-center">
              <MdOutlineMail />
              <p className="text-sm leading-6 text-gray-600">
            ...
            <div className="flex space-x-6">
              {navigation.social.map((item) => (
                ...
                >
                  ...
                  <item.icon key={item.name} aria-hidden="true" />
                </Link>
              ))}
            </div>
          </div>
