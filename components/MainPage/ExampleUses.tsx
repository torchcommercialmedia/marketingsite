...
const ExampleUses = (props: Props) => {
  return (
    <section className="min-h-screen w-full flex justify-center items-center flex-col mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div className="mx-auto grid max-w-lg grid-cols-2 items-center gap-x-8 gap-y-8 sm:max-w-xl sm:grid-cols-2 lg:grid-cols-4 sm:gap-x-10 sm:gap-y-10 lg:mx-0 lg:max-w-none">
