import { InboxIcon, TrashIcon, UsersIcon, CalendarDaysIcon, ChartBarSquareIcon } from '@heroicons/react/24/outline'
...
const features = [
  ...
  },
  {
    name: 'Analyze Stats',
    description:
      'Get stats on your business, and more',
    href: '#',
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Robust support tools to help you service your customers, and keep them happy.
          </p>
        </div>
