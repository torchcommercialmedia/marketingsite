...
const features = [
  {
    name: 'Task Tracker',
    summary: 'Get in-depth insight on every single vehicle',
    description:
      'Pivot data by vehicle, by task type, or by user assigned.  Speed your time to market, and identify pain points.',
